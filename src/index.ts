...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    ...
    switch (name) {
      case 'create_skill':
        result = createSkill(args as unknown as Parameters<typeof createSkill>[0]);
        break;
      case 'validate_skill':
        result = validateSkill(args as unknown as Parameters<typeof validateSkill>[0]);
        break;
      case 'analyze_description':
        result = analyzeDescription(args as unknown as Parameters<typeof analyzeDescription>[0]);
        break;
      case 'list_skills':
        result = listSkills((args ?? {}) as unknown as Parameters<typeof listSkills>[0]);
        break;
      case 'get_skill':
        result = getSkill(args as unknown as Parameters<typeof getSkill>[0]);
        break;
      case 'update_skill':
        result = updateSkill(args as unknown as Parameters<typeof updateSkill>[0]);
        break;
      case 'match_skill':
        result = matchSkill(args as unknown as Parameters<typeof matchSkill>[0]);
        break;
      case 'record_skill_usage':
        result = recordSkillUsage(args as unknown as Parameters<typeof recordSkillUsage>[0]);
        break;
      default:
