...
const signalCodes = Object.entries(signalNames).reduce((acc, [code, name]) => ({ ...acc, [name]: parseInt(code) }), {});
/**
 ...
 * Create a new signal
 */
export function createSignal(code, sender, data) {
    return {
        code,
        name: getSignalName(code),
        sender,
 ...
 */
export function getSignalCode(name) {
